<template>
  ...
  <PropertyForm
    ...
    :property="submodelElementToEdit"
  />
  <!-- Dialog for creating/editing MultiLanguageProperties -->
  <MLPForm
    v-model="mlpDialog"
    :mlp="submodelElementToEdit"
    :new-mlp="newMLP"
    :parent-element="elementToAddSME"
    :path="submodelElementPath"
  />
  ...
  <RangeForm
    ...
    :parent-element="elementToAddSME"
    :path="submodelElementPath"
    :range="submodelElementToEdit"
  />
  <!-- Dialog for creating/editing File SubmodelElements -->
  <FileForm
    v-model="fileDialog"
    :file="submodelElementToEdit"
    :new-file="newFile"
    :parent-element="elementToAddSME"
    :path="submodelElementPath"
  />
  ...
  <ReferenceElementForm
    ...
    :parent-element="elementToAddSME"
    :path="submodelElementPath"
    :reference-element="submodelElementToEdit"
  />
  ...
  <RelationshipElementForm
    ...
    :parent-element="elementToAddSME"
    :path="submodelElementPath"
    :relationship-element="submodelElementToEdit"
  />
  ...
  <AnnotatedRelationshipElementForm
    ...
    :annotated-relationship-element="submodelElementToEdit"
