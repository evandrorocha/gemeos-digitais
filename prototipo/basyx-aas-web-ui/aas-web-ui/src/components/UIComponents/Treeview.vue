    ...
    <v-hover>
      <template #default="{ isHovering, props }">
        <div
          ...
          @pointerdown.stop="selectAndOpen(item)"
          @pointerup.stop="selectAndOpen(item)"
        >
          <v-list-item
...
<script lang="ts" setup>
  ...
  function selectAndOpen (smOrSme: any): void {
    selectSmOrSme(smOrSme)
    openTree(smOrSme)
  }
